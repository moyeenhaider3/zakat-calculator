...
const translations = {
  ...
  "asset.verifyGold": {
    en: "For accurate results, verify the current 24K gold rate (e.g. goldprice.org). If it differs significantly, tap 📝 to correct it.",
    hi: "सटीक परिणाम के लिए वर्तमान 24K सोने की क़ीमत जाँचें। अंतर ज़्यादा हो तो 📝 से अपडेट करें।",
    ur: "درست نتائج کے لیے موجودہ 24K سونے کی قیمت جانچیں۔ فرق زیادہ ہو تو 📝 سے درست کریں۔",
    ar: "للحصول على نتائج دقيقة، تحقق من سعر الذهب 24K الحالي. إذا كان الفرق كبيرًا، اضغط 📝 لتصحيحه.",
  },
  "asset.verifySilver": {
    en: "For accurate results, verify the current silver rate. If it differs significantly, tap 📝 to correct it.",
    hi: "सटीक परिणाम के लिए वर्तमान चांदी की क़ीमत जाँचें। अंतर ज़्यादा हो तो 📝 से अपडेट करें।",
    ur: "درست نتائج کے لیے موجودہ چاندی کی قیمت جانچیں۔ فرق زیادہ ہو تو 📝 سے درست کریں۔",
    ar: "للحصول على نتائج دقيقة، تحقق من سعر الفضة الحالي. إذا كان الفرق كبيرًا، اضغط 📝 لتصحيحه.",
  },
  "asset.enterWeight": {
    en: "Enter Weight",
    hi: "वज़न दर्ज करें",
